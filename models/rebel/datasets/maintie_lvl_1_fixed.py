...
_DESCRIPTION = """MaintIE is made of sentences from maintenance texts, annotated with five entity types and six relation types."""
...
class MAINTIE(datasets.GeneratorBasedBuilder):
    ...
    def _generate_examples(self, filepath):
        ...
        logging.info(
            "generating examples from = %s", file_path
